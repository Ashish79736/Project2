export default function Product(){
    return(
        ...
        <div className="container">
          ...
          <p className="lorem_text1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin bibendum, est ac faucibus
            hendrerit, mauris ante viverra urna, in elementum urna est ut ligula.</p>
            ...
            <div className="row">
              <div className="col-lg-4 col-sm-12">
                ...
                <div className="month_main clearfix">
                  ...
                  <p className="long_text">It is a long established f
                    act distracteontent </p>
                </div>
                <div className="seemore_main">
                  <div className="see_more"><a href="#">SEE MORE</a></div>
                </div>
              </div>
              <div className="col-lg-4 col-sm-12">
